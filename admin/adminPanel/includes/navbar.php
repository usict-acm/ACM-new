        ...
        <ul style="transform: scale(1.4); transform-origin: top left; z-index: 10;" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">ACM Backend</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="?table=addAnnouncement">
            ...
            <div class="text-center d-none d-md-inline">
                <button class="rounded-circle border-0" id="sidebarToggle"><i class="fas fa-arrow-left" style="color:#fff"></i></button>
            </div>
        </ul>
        <!-- End of Sidebar -->
