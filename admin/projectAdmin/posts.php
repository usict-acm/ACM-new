...
class Post
{
  ...
  {
    $query = 'SELECT b.projectId, b.projectTitle, b.userName, b.content, b.published, b.coverImage, b.tags FROM ' . $this->table . ' b WHERE approved=1 AND isDraft=0 ORDER BY published DESC LIMIT ' . $start . ',' . $limit;
  ...
  {
    // Create query
    $query = 'SELECT b.projectId, b.projectTitle, b.userName, b.content, b.published, b.coverImage, b.tags
                                FROM ' . $this->table . ' b
  ...
  {
    // Create query
    $query = 'SELECT b.projectId, b.projectTitle, b.user_ids, b.content, b.coverImage
                                FROM ' . $this->table . ' b
                                WHERE projectId=' . $Sno;
