...
<body>
  ...
  ?>
  <!-- ************************************************All Clubs************************************************************************* -->
  <section class="clubs-head">
    <img src="./assets/images/clubs/Background_shapes/Bg_shape_5.svg" class="bg-shape" id="bg-shape-11" />
    <div class="container">
      <div class="row pageTitle">
        <img class="bg-shape" id="bg-shape-1" src="./assets/images/clubs/Background_shapes/Bg_shape_1.svg" />
        <h1>ACM CLUBS</h1>
        <p>
    ...
    <div class="club-container">
      <img src="./assets/images/clubs/Background_shapes/Bg_shape_2.svg" class="bg-shape" id="bg-shape-2" />
    ...
    <div class="club-container">
      <div class="row club-row">
        <div class="club container">
          <img src="assets/images/clubs/Background_shapes/Bg_shape_3.svg" class="bg-shape" id="bg-shape-3" />
          <div class="lvlimg">
            <div class="lead">
              <div class="img">
