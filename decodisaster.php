...
<meta name="twitter:image" content="./assets/images/acm1.png">
  ...
  <link href='assets/CSS/decodisaster.css' rel="stylesheet" />
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse1">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item active"> <a class="nav-link" href="./collab.html">Sponsors</a> </li>
  ...
  <section id="collab">
    <div class="container">
      ...
      <div class="row d-flex justify-content-center">
        <a class="collab-card" target="_blank" href="./assets/images/DecoDisaster/Clue 1.pdf">
            <div>
          <hr class="blue-hr">
          ...
          <a class="collab-card" target="_blank" href="./assets/images/DecoDisaster/Clue 2.pdf">
            <div>
            <hr class="blue-hr">
          ...
          <a class="collab-card" target="_blank" href="./assets/images/DecoDisaster/Clue 3.pdf">
            <div>
            <hr class="blue-hr">
          ...
          <a class="collab-card" target="_blank" href="./assets/images/DecoDisaster/Clue 4.pdf">
            <div>
            <hr class="blue-hr">
          ...
          <a href="./assets/images/DecoDisaster/Clue 5.pdf" target="_blank" class="collab-card">
          <div>
            <hr class="blue-hr">
          ...
          <a href="./assets/images/DecoDisaster/Clue 6.pdf" target="_blank" class="collab-card">
          <div>
            <hr class="blue-hr">
