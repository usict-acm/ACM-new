...
<section id="content">
    ...
    <div class="row">
        <div style="margin:auto;" id="pagination_row_2019"></div>
    </div>
</section>
...
?>
  ...
  <script>
    let urlEvent = '../admin/blogAdmin/api.php/?q=readAllEvent&year=2019&page='+<?php echo $page ?>;
    let allEvents=document.getElementById("eventPage");
    let pagination = document.getElementById("pagination_row_2019");
    allEvents.innerHTML="";
    ...
    $(document).ready(function() {
        ...
        pagination.innerHTML += "<nav style=display:inline-block; aria-label=Page navigation example>\
                                            <ul class=pagination>\
                                                <li class=page-item >\
                                                <a id='previous-pagination' class='page-link pagination-option-next-prev' href=./2019.php?q=readAllEvent&year=2019&page=<?php echo $previous ?> disabled>\
                                                    < Prev\
                                                </a>\
                                                </li>\
                                            </ul>\
        ...
        for (var i = 1; i <= data[2]; i++) {
                    ...
                    pagination.innerHTML += "<nav style=display:inline-block; aria-label=Page navigation example>\
                                                <ul class=pagination>\
                                                    <li class=page-item>\
                                                    <a id=" + id + " class='page-link pagination-numbers pagination-option-next-prev '" + "href=./2019.php?q=readAllEvent&year=2019&page=" + i + ">\
                                                        " + i + "\
                                                    </a>\
                                                    </li>\
                                                </ul>\
        ...
        var next = <?php echo $page ?> === data[2] ? data[2] : <?php echo $page + 1 ?>;
                pagination.innerHTML += "<nav style=display:inline-block; aria-label=Page navigation example>\
                                            <ul class=pagination>\
                                                <li class=page-item>\
                                                <a id='next-pagination' class='page-link pagination-option-next-prev' href=./2019.php?q=readAllEvent&year=2019&page=" + next + ">\
                                                    Next >\
                                                </a>\
                                                </li>\
                                            </ul>\
