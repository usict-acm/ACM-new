                    ...
                    function allEvent(event) {
                        allEvents.innerHTML +=" <div class='event-post'>\
                                                    ...
                                                    <div class='event-post_info'>\
                                                        ...
                                                        <a href="+event.viewResorce+" style='float: right;' target='_blank'><button class='dateTime-para btn form-input-boxes-manual event-button-two btn-watch' style='font-size: 16px;'>View Resource</button></a>\
                                                    </div>\
                                                </div>";
                    }
