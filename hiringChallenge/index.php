            ...
            <div class="content">
                <div class="left-side">
                    <div class="address details">
                        ...
                        <div class="text-one" style="margin-bottom: 10px;">Usict Delhi Sector-14</div>
                        <style>
                            #frame {
                                border: 3px dotted;
                                width: 250px;
                    ...
                    <div class="contact-container" style="display: flex; justify-content: space-around; width: 400px;">
